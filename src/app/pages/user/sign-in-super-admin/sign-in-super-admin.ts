...
@Component({
  selector: 'app-sign-in-super-admin',
  imports: [ReactiveFormsModule],
  templateUrl: './sign-in-super-admin.html',
...
export class SignInSuperAdmin implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.SignInForm = this.fb.group({
      ...
      impersonatePublicUid: ['', [Validators.required]],
    });
  }
  ...
  onSubmit() {
    ...
    this.userService.getSuperAdminUserToken(formData).subscribe({
      next: (response) => {
